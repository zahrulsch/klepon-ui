                    ...
                    >
                        <div class="p-4 bg-white max-w-[400px] mx-auto shadow-lg rounded-xl flex flex-col items-center gap-0.5">
                            <p class="">
                                ...
                                sehingga memudahkan pengembang Java untuk beralih. Kotlin terkenal
                                karena sintaksisnya yang ringkas, sistem tipe yang aman dari null,
                                dan dukungan untuk pemrograman asinkron melalui coroutine. Bahasa
                                ini banyak digunakan dalam pengembangan aplikasi Android, di mana
                                Kotlin diakui sebagai bahasa pilihan oleh Google, serta dalam
                                pengembangan aplikasi server dan web. Fitur menarik lainnya termasuk
                                fungsi ekstensi dan kemampuan pengembangan multiplatform, yang
                                memungkinkan berbagi kode di berbagai platform seperti iOS dan web.
                                Dengan dokumentasi resmi yang lengkap dan komunitas yang aktif,
                                Kotlin menjadi pilihan yang semakin populer di kalangan pengembang.
                            </p>
                        </div>
                    </Dialog>
